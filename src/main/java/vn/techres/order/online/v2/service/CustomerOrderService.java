package vn.techres.order.online.v1.service;
...
public interface CustomerOrderService {
        CustomerOrder spUCreateOnlineOrder(int restaurantId,
                        ...
                        String foodData,
                        String note,
                        int customerOrderOnlineStatus) throws Exception;
...
>>>>>>> 40c75648976d1f1e9bd140bb3a9930f538e92ed8
        ...
        CustomerOrder spUCreateCustomerOrder(int restaurantId, int restaurantBrandId, int branchId, int areaId,
                        int tableId, String foodsJson,
                        String foodData, String tableName, String note) throws Exception;
